const features = [
  ...
  {
    title: 'Running Water',
    description: 'Full plumbing with running water for a true luxury experience.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Granite countertops and premium fixtures throughout.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Multiple private stalls with LED mirrors and ample space.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
